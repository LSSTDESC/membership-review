...
When all else fails post on #desc-help (Slack) or send email to lsst-desc-help at slac.stanford.edu.  Please include a screenshot of your browser window including the URL for any error messages or to display what you see when connected to your DESC Member database entry.
